...
const GlobalExpenses: React.FC = () => {
  ...
  const getAuditBadge = (exp: ExpenseWithAudit) => {
      ...
      // Seule alerte "réelle" conservée : Coût très élevé (> 500€/mois)
  ...
  return (
    ...
    <div className="space-y-6 animate-fade-in-up pb-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-4">
            <div>
                <h1 className="text-3xl font-extrabold text-slate-900">Inventaire des Coûts</h1>
                <p className="text-slate-500 mt-1">Analyse de la répartition budgétaire des outils connectés.</p>
            </div>
