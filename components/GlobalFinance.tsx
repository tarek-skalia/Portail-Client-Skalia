...
import { DollarSign, TrendingUp, AlertTriangle, Search, Filter, Plus, Edit3, Trash2 } from 'lucide-react';
  ...
  return (
    ...
    <div className="space-y-6 animate-fade-in-up pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className={`p-6 rounded-2xl border shadow-sm flex items-center justify-between ${overdueRevenue > 0 ? 'bg-red-50 border-red-200' : 'bg-white border-slate-200'}`}>
                <div>
